...
class ShowViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let videoName = videoName, let videoURL = Bundle.main.url(forResource: videoName, withExtension: "mov") {
        ...
        if let videoName2 = videoName2, let videoURL2 = Bundle.main.url(forResource: videoName2, withExtension: "mov") {
